  ...
  <div className="hero-content text-center text-neutral-content">
    <div className="max-w-md">
      <h1    data-aos-delay="100"
                  ...
                  data-aos="fade-left" className="mb-5 text-5xl text-white font-bold">Manage Your Tasks</h1>
      <p     data-aos-delay="1100"
                  data-aos-duration="2000"
                  data-aos-easing="ease-in-out"
                  data-aos="fade-right" className="mb-5 ">
Your streamlined tak management solution! Dive into a world where creating, updating, and deleting tasks is a breeze.  Manage your progress seamlessly by toggling task statuses, all within a user-friendly interface. Taskify: Simplify, Organize, Achieve. Your tasks, your way, anytime, anywhere.</p>
      ...
      <Link to={"/register"}>  <button    data-aos="fade-up"
                  data-aos-delay="2100"
                  data-aos-duration="2000"
                  data-aos-easing="ease-in-out" className="btn bg-black btn-primary border-0 text-white">Register</button></Link>
